...
plot2svg(['~/Dropbox (Personal)/MHb Figure Drafts/Revisions/HeadFixedBehavior/Opto/WithStim/panels/' cohort '/animalAverage_' cohort '_' SessionType '.svg'],gcf)
...
b = barwitherr([nanstd(y1), nanstd(y2)]./sqrt(numel(y1)),[nanmean(y1), nanmean(y2)],'facecolor', 'flat');
b.CData(1,:) = [ 0 0 0 ]; b.CData(2,:) = colorNum; b.EdgeAlpha = .5;  hold on
...
print(['~/Dropbox (Personal)/MHb Figure Drafts/Revisions/HeadFixedBehavior/Opto/WithStim/panels/' cohort '/AveEndBlock_' cohort '_' SessionType '.pdf'],'-dpdf')
